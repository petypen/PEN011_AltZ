...
Функция вСформироватьОписаниеРазработки() Экспорт
	...
	пСтрук.Вставить("Наименование", "СДР: Редактор объекта ИБ");
	пСтрук.Вставить("НомерВерсии", "1.1.0.71");
	пСтрук.Вставить("ДатаВерсии", "07.05.2023");
	пСтрук.Вставить("Описание", "https://infostart.ru/public/983887/");

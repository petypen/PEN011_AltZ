...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ТипЗнч(ДанныеХЗ) = Тип("ТекстовыйДокумент") Тогда
		...
		Возврат;
	ИначеЕсли ТипЗнч(ДанныеХЗ) = Тип("Строка") Тогда
		_ДанныеДляОтображения = новый Структура("Значение, ТипЗначения", ДанныеХЗ, "Строка");
		Возврат;
	...
	ИначеЕсли ТипДанныхХЗ = Тип("ТекстовыйДокумент") Тогда
		_ДанныеДляОтображения = новый Структура("Значение, ТипЗначения", ДанныеХЗ, "ТекстовыйДокумент");
	ИначеЕсли ТипДанныхХЗ = Тип("Строка") Тогда
		_ДанныеДляОтображения = новый Структура("Значение, ТипЗначения", ДанныеХЗ, "Строка");
	Иначе
		Отказ = истина;
	КонецЕсли;
...
Процедура ПриОткрытии(Отказ)
	...
	Если _ДанныеДляОтображения <> Неопределено Тогда
		...
		ИначеЕсли _ДанныеДляОтображения.ТипЗначения = "ТекстовыйДокумент" Тогда
			_ДанныеДляОтображения.Значение.Показать(_ДанныеДляОтображения.ТипЗначения);
		ИначеЕсли _ДанныеДляОтображения.ТипЗначения = "Строка" Тогда
			пТекстовыйДокумент = новый ТекстовыйДокумент;
			пТекстовыйДокумент.УстановитьТекст(_ДанныеДляОтображения.Значение);
			пТекстовыйДокумент.Показать(_ДанныеДляОтображения.ТипЗначения);
		КонецЕсли;
